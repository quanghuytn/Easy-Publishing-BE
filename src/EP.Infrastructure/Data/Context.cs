        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
                ...
                entity.HasMany(d => d.Stories).WithMany(p => p.Categories)
                    .UsingEntity<Dictionary<string, object>>(
                        ...
                        r => r.HasOne<Story>().WithMany()
                            ...
                            .HasConstraintName("FK__Story_Cat__story__5BE2A6F2"),
                        l => l.HasOne<Category>().WithMany()
                            .HasForeignKey("CategoryId")
                            .OnDelete(DeleteBehavior.ClientSetNull)
                            .HasConstraintName("FK__Story_Cat__categ__5CD6CB2B"),
                        j =>
                        {
            ...
            modelBuilder.Entity<Chapter>(entity =>
            {
                ...
                entity.HasOne(d => d.Story).WithMany(p => p.Chapters)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Chapter__story_i__5EBF139D");

                entity.HasOne(d => d.Volume).WithMany(p => p.Chapters)
                    .HasForeignKey(d => d.VolumeId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Chapter__volume___5FB337D6");
            });
            ...
            modelBuilder.Entity<ChapterLiked>(entity =>
            {
                ...
                entity.HasOne(d => d.Chapter).WithMany(p => p.ChapterLikeds)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Chapter_L__chapt__6383C8BA");

                entity.HasOne(d => d.User).WithMany(p => p.ChapterLikeds)
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Chapter_L__user___628FA481");
            });
            ...
            modelBuilder.Entity<Comment>(entity =>
            {
                ...
                entity.HasOne(d => d.Chapter).WithMany(p => p.Comments)
                    .HasForeignKey(d => d.ChapterId)
                    .HasConstraintName("FK__Comment__chapter__66603565");

                entity.HasOne(d => d.Story).WithMany(p => p.Comments)
                    .HasForeignKey(d => d.StoryId)
                    .HasConstraintName("FK__Comment__story_i__656C112C");
            ...
            modelBuilder.Entity<RefundRequest>(entity =>
            {
                ...
                entity.HasOne(d => d.Wallet).WithMany(p => p.RefundRequests)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Refund_Re__walle__4E88ABD4");
            });
            ...
            modelBuilder.Entity<ReportContent>(entity =>
            {
                ...
                entity.HasOne(d => d.Chapter).WithMany(p => p.ReportContents)
                    .HasForeignKey(d => d.ChapterId)
                    .HasConstraintName("FK__ReportCon__chapt__6A30C649");

                entity.HasOne(d => d.Comment).WithMany(p => p.ReportContents)
                    .HasForeignKey(d => d.CommentId)
                    .HasConstraintName("FK__ReportCon__comme__6B24EA82");

                entity.HasOne(d => d.ReportType).WithMany(p => p.ReportContents)
                    .HasForeignKey(d => d.ReportTypeId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__ReportCon__repor__68487DD7");

                entity.HasOne(d => d.Story).WithMany(p => p.ReportContents)
                    .HasForeignKey(d => d.StoryId)
                    .HasConstraintName("FK__ReportCon__story__693CA210");

                entity.HasOne(d => d.User).WithMany(p => p.ReportContents)
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__ReportCon__user___6754599E");
            });
            ...
            modelBuilder.Entity<Review>(entity =>
            {
                ...
                entity.HasOne(d => d.Chapter).WithMany(p => p.Reviews)
                    .HasForeignKey(d => d.ChapterId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Review__chapter___6E01572D");

                entity.HasOne(d => d.User).WithMany(p => p.Reviews)
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Review__user_id__6D0D32F4");
            });

            modelBuilder.Entity<Role>(entity =>
            {
                entity.HasKey(e => e.RoleId).HasName("PK__Role__760965CCCCFE19FC");
            ...
            modelBuilder.Entity<Story>(entity =>
            {
                ...
                entity.HasOne(d => d.Author).WithMany(p => p.Stories)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Story__author_id__59FA5E80");
            });
            ...
            modelBuilder.Entity<StoryFollowLike>(entity =>
            {
                ...
                entity.HasOne(d => d.Story).WithMany(p => p.StoryFollowLikes)
                    .HasForeignKey(d => d.StoryId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Story_Fol__story__5629CD9C");

                entity.HasOne(d => d.User).WithMany(p => p.StoryFollowLikes)
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Story_Fol__user___571DF1D5");
            });
            ...
            modelBuilder.Entity<StoryInteraction>(entity =>
            {
                ...
                entity.HasOne(d => d.Story).WithOne(p => p.StoryInteraction)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Story_Int__story__5AEE82B9");
            });
            ...
            modelBuilder.Entity<StoryRead>(entity =>
            {
                ...
                entity.HasOne(d => d.Chapter).WithMany(p => p.StoryReads)
                    .HasForeignKey(d => d.ChapterId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Story_Rea__chapt__5535A963");

                entity.HasOne(d => d.Story).WithMany(p => p.StoryReads)
                    .HasForeignKey(d => d.StoryId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Story_Rea__story__5441852A");

                entity.HasOne(d => d.User).WithMany(p => p.StoryReads)
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Story_Rea__user___534D60F1");
            });
            ...
            modelBuilder.Entity<Ticket>(entity =>
            {
                ...
                entity.HasOne(d => d.User).WithMany(p => p.Tickets)
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Ticket__user_id__6EF57B66");
            });
            ...
            modelBuilder.Entity<Transaction>(entity =>
            {
                ...
                entity.HasOne(d => d.Chapter).WithMany(p => p.Transactions)
                    .HasForeignKey(d => d.ChapterId)
                    .HasConstraintName("FK__Transacti__chapt__52593CB8");

                entity.HasOne(d => d.Story).WithMany(p => p.Transactions)
                    .HasForeignKey(d => d.StoryId)
                    .HasConstraintName("FK__Transacti__story__5165187F");

                entity.HasOne(d => d.Wallet).WithMany(p => p.Transactions)
                    .HasForeignKey(d => d.WalletId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Transacti__walle__5070F446");
            });
                ...
                entity.HasMany(d => d.Chapters).WithMany(p => p.Users)
                    .UsingEntity<Dictionary<string, object>>(
                        ...
                        r => r.HasOne<Chapter>().WithMany()
                            ...
                            .OnDelete(DeleteBehavior.ClientSetNull)
                            .HasConstraintName("FK__Chapter_O__chapt__619B8048"),
                        l => l.HasOne<User>().WithMany()
                            .HasForeignKey("UserId")
                            .OnDelete(DeleteBehavior.ClientSetNull)
                            .HasConstraintName("FK__Chapter_O__user___60A75C0F"),
                        j =>
                        {
                ...
                entity.HasMany(d => d.StoriesNavigation).WithMany(p => p.Users)
                    .UsingEntity<Dictionary<string, object>>(
                        ...
                        r => r.HasOne<Story>().WithMany()
                            .HasForeignKey("StoryId")
                            .OnDelete(DeleteBehavior.ClientSetNull)
                            .HasConstraintName("FK__Story_Own__story__5812160E"),
                        l => l.HasOne<User>().WithMany()
                            .HasForeignKey("UserId")
                            .OnDelete(DeleteBehavior.ClientSetNull)
                            .HasConstraintName("FK__Story_Own__user___59063A47"),
                        j =>
                        {
            ...
            modelBuilder.Entity<Volume>(entity =>
            {
                ...
                entity.HasOne(d => d.Story).WithMany(p => p.Volumes)
                    .HasForeignKey(d => d.StoryId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Volume__story_id__5DCAEF64");
            });
            ...
            modelBuilder.Entity<Wallet>(entity =>
            {
                ...
                entity.HasOne(d => d.User).WithMany(p => p.Wallets)
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Wallet__user_id__4F7CD00D");
            });
